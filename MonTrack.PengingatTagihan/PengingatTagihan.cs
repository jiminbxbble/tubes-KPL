...
namespace MonTrack_PengingatTagihan
{
    ...
    public class PengingatTagihan
    {
        ...
        private static readonly Dictionary<string, KonfigurasiTagihan> TabelKonfigurasi = new Dictionary<string, KonfigurasiTagihan>(StringComparer.OrdinalIgnoreCase)
        {
    ...
    public class TagihanManager
    {
        ...
        // Mengembalikan IReadOnlyList agar list tidak bisa di-modifikasi sembarangan (Add/Remove) dari luar.
